---
{"dg-publish":true,"permalink":"/01-fleeting-notes/modlist-for-boss-miriam/","metatags":{"description":"A minimal, vanilla-friendly modlist I came up with for my friend who wanted to get into Morrowind but was put off by some of its ancient Bethesda jank","og:image":"https://i.imgur.com/LmCg5HX.png"},"tags":["Modlist"]}
---
...
| Mod                                                                                                                 | Installation Folders                                                                                                                                                           |
| ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Patch for Purists](https://www.nexusmods.com/morrowind/mods/45096)                                                 | 📂 `PatchforPurists`                                                                                                                                                           |
| [Unofficial Official Morrowind Plugins Patched](https://www.nexusmods.com/morrowind/mods/43931)                     | 📂 `UnofficialMorrowindOfficialPluginsPatched`   <br>├─📂 `02 bitter coast sounds`<br>├─📂 `03 entertainers`<br>├─📂 `05 lefemm armor`<br>├─📂 `05 lefemm armor compatibility` |
| [Bethesda Official Plugins Naturalized](https://www.nexusmods.com/morrowind/mods/51107)                             | 📂 `BethesdaOfficialPluginsNaturalized`                                                                                                                                        |
| [Expansion Delay](https://www.nexusmods.com/morrowind/mods/47588)                                                   | 📂 `ExpansionDelay`                                                                                                                                                            |
| [Beware the Sixth House (Sixth House Overhaul)](https://www.nexusmods.com/morrowind/mods/46036)                     | 📂 `BewaretheSixthHouse`                                                                                                                                                       |
| [Tribunal Rebalance](https://www.nexusmods.com/morrowind/mods/45713)                                                | 📂 `TribunalRebalance`                                                                                                                                                         |
| [Bloodmoon Rebalance](https://www.nexusmods.com/morrowind/mods/45714)                                               | 📂 `Bloodmoon Rebalance`                                                                                                                                                       |
| [Morrowind Optimization Patch](https://www.nexusmods.com/morrowind/mods/45384)                                      | 📂 `MorrowindOptimizationPatch`<br>├─📂 `01 Lake Fjalding Anti-Suck`<br>├─📂 `02 Weapon Sheathing Patch`<br>├─📂 `05 Graphic Herbalism Patch`                                  |
| [Project Atlas](https://www.nexusmods.com/morrowind/mods/45399)                                                     | 📂 `ProjectAtlas`<br>├─📂 `00 Core`<br>├─📂 `06 Glow in the Dahrk Patch`<br>├─📂 `07 Graphic Herbalism Patch`                                                                  |
| [Graphic Herbalism - (MWSE and OpenMW Edition)](https://www.nexusmods.com/morrowind/mods/46599)                     | 📂 `GraphicHerbalismMWSEandOpenMWEdition`<br>├─📂 `00 Core + Vanilla Meshes`                                                                                                   |
| [Dynamic Distant Buildings for OpenMW](https://www.nexusmods.com/morrowind/mods/51236)                              | 📂 `DynamicDistantBuildingsforOpenMW`<br>├─📂 `Dynamic Distant Details`                                                                                                        |
...
| [Vanilla-Flavoured Hair - a Hair Mesh Replacer Mod](https://www.nexusmods.com/morrowind/mods/49910?tab=description) |                                                                                                                                                                                |
...
> data="C:\games\OpenMWMods\UserInterface\NZdawghaus' Widescreen Splash Replacer\00 Core"
> data="C:\games\OpenMWMods\Fonts\BetterDialogueFont"
> data="C:\games\OpenMWMods\NPCs\kart_facelift_meshes"
...
> content=Siege at Firemoth Naturalized.es
